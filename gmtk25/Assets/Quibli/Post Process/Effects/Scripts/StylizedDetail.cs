...
public class StylizedDetailRenderer : CompoundRenderer {
    ...
    public override void RenderWithGraph(RenderGraph renderGraph, TextureHandle source, TextureHandle destination,
        ...
        TextureHandle blur1 =
            UniversalRenderer.CreateRenderGraphTexture(renderGraph, intermediateDescriptor, "_BlurTex1", clear: true);
        TextureHandle blur2 =
            UniversalRenderer.CreateRenderGraphTexture(renderGraph, intermediateDescriptor, "_BlurTex2", clear: true);
        ...
        {
            // _effectMaterial.SetTexture(PropertyIDs.Blur1, blur1);
            // _effectMaterial.SetTexture(PropertyIDs.Blur2, blur2);

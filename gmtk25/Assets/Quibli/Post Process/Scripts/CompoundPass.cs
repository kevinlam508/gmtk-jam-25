...
public class CompoundPass : ScriptableRenderPass {
    ...
    public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData) {
        ...
        TextureHandle dst = dstIntermediate;
        ...
        // Ping-pong between src and dst for each renderer.
        ...
        // If landed on the intermediate RT, we need to blit back to the destination.
        if (m_ActivePostProcessRenderers.Count % 2 == 1) {
